...
To follow along, please [[Forking a Repository|fork and clone]] this [starter project](https://github.com/lcs-rgordon/LCSHouses/).

Compared to the [[Abstraction Using Lists#A complete example|example code shared in our prior class]], the project you just forked and cloned has only a couple of differences.
...
> [!NOTE]
> 
> See if you can spot what is wrong, or out of date, with the details provided for each house. 👀 
