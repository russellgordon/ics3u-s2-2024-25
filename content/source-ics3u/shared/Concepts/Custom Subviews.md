...
created: 2024-12-05T00:00:00.000-0400
...
Please follow this link to see [Mr. Gordon's repository](https://github.com/lcs-rgordon/GeometricFigures2024S2) for his **Geometric Figures** app – then [[Forking a Repository|create a fork]] of his repository, and [[Forking a Repository#Cloning|clone your fork]] to your own computer.

When complete, you should have a project that looks like this:

![[Screenshot 2024-12-04 at 8.05.23 PM.png]]

Open the **Source Control** navigator by pressing **Command-2**:

![[Screenshot 2024-12-04 at 8.05.48 PM.png]]

Then tap the **Repositories** tab:

![[Screenshot 2024-12-04 at 8.06.16 PM.png]]

Expand the disclosure triangle at top-left by clicking on it:

![[Screenshot 2024-12-04 at 8.06.47 PM.png]]

Then expand the disclosure triangle for the **Remotes** section:

![[Screenshot 2024-12-04 at 8.07.46 PM.png]]
...
![[Screenshot 2024-12-04 at 8.09.10 PM.png]]
...
<div style="padding:56.25% 0 0 0;position:relative;">
	<iframe src="https://player.vimeo.com/video/1036201322?h=ed698d8505&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479&portrait=0&byline=0&title=0" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Opening the Teamspace">
	</iframe>
	</div>
...
1. What is the advantage of using a custom subview, or helper view?
2. To make code readable, what should always be true about the name we select for a structure we've defined?